...
class EdgeMinibatchIterator(object):
    ...
    def next_minibatch_feed_dict(self, placeholders):
        ...
        batch_edges = self.test_edges[i,j][k][start: start + self.batch_size]
    ...
    def num_training_batches(self, edge_type, type_idx):
        ...
        return len(self.test_edges[edge_type][type_idx]) // self.batch_size + 1
    ...
    def shuffle(self):
        ...
        for edge_type in self.edge_types:
            for k in range(self.edge_types[edge_type]):
                ...
                self.test_edges[edge_type][k] = np.random.permutation(self.test_edges[edge_type][k])
